...
abstract class IOTestSuite[F[_], AF[_], Global, Local]
  ...
  lazy val properties: IOProps[F, AF, _, _] =
    synchronized {
      ...
      IOProps[F, AF, Global, Local](gb, lb, propertiesSeq.toList)
    }
