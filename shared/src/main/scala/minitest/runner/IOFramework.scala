...
import minitest.runner.IOFramework.ModuleFingerprint
import sbt.testing.{ Framework => BaseFramework, Runner => BaseRunner, _ }

class IOFramework extends BaseFramework {
  def name(): String = "minitest-io"
  ...
  def runner(
    ...
    new IORunner(args, remoteArgs, testClassLoader)
...
object IOFramework {
  ...
  object ModuleFingerprint extends SubclassFingerprint {
    ...
    def superclassName(): String           = "minitest.api.AbstractIOTestSuite"
  }
}
